      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground mt-3 text-lg">
            Learn about localized carbon accounting in India. Demystify the factors behind your
            electricity bills, daily commute, and food choices.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {articles.map((article, idx) => {
            ...
            return (
              <article
                key={idx}
                className="glass p-8 rounded-2xl border border-border shadow-lg flex flex-col justify-between"
              >
                <div>
        ...
        <section className="mt-16 glass p-8 rounded-2xl border border-border bg-gradient-to-r from-primary/5 to-transparent flex flex-col md:flex-row gap-6 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-3xl">
              By logging daily activities, tracking your metrics, and committing to small,
              actionable tweaks (e.g. taking a metro instead of a taxi or turning off the AC for two
              hours), you can reduce your personal emission profile. Small collective changes create
              major national impacts.
            </p>
          </div>
        </section>
      </main>
